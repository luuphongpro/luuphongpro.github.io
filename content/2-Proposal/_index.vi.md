...
### 1. Tóm tắt điều hành  
RoomMate là nền tảng hỗ trợ tìm kiếm và quản lý phòng trọ, được thiết kế dành riêng cho sinh viên và chủ trọ. Hệ thống tận dụng kiến trúc Serverless trên AWS nhằm tối ưu chi phí, khả năng mở rộng và đơn giản hóa vận hành.

Nền tảng cho phép chủ trọ đăng tin, quản lý thông tin phòng (thêm – sửa – xóa) và nhận báo cáo định kỳ. Người thuê có thể tìm kiếm theo nhiều tiêu chí như vị trí, giá, tiện ích; lưu phòng yêu thích; và trao đổi trực tiếp với chủ trọ thông qua tính năng chat tích hợp.

Kiến trúc hệ thống sử dụng **Next.js** cho giao diện người dùng, **API Gateway + Lambda** cho backend, **DynamoDB** cho lưu trữ dữ liệu chính, cùng với các dịch vụ xác thực an toàn. Một điểm nổi bật của RoomMate là khả năng ứng dụng **OpenAI** để tự động hóa: gửi thông báo khi có phòng phù hợp, hỗ trợ tạo báo cáo thống kê và nâng cao mức độ tương tác của hệ thống.  
...
- Trước thực tập (Tháng 0): 1 tháng lên kế hoạch và đánh giá hệ thống.
- Thực tập (Tháng 1–3):
...
- S3 - Front End bucket: 0,00 USD/tháng (6 GB).
...
- Mạng: Sử dụng CloudFront để phân phối nội dung với độ trễ thấp.
...
### 8. Kết quả kỳ vọng  
*Cải tiến kỹ thuật*: Dữ liệu và phân tích thời gian thực thay thế quy trình thủ công. Tăng độ chính xác của chatbot AI khi tư vấn cho người dùng
